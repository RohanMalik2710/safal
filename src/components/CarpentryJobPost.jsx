...
const CarpentryJobPost = () => {
  ...
  const mockLaborers = [
    { id: 1, name: 'John Doe', expertise: 'Carpentry', rating: 4.5 },
    { id: 2, name: 'Jane Smith', expertise: 'Carpentry', rating: 4.2 },
    // Other mock laborer data
  ];

  return (
    <div className="container mx-auto px-4 py-8 min-w-auto">
      <h2 className="text-3xl font-bold mb-4 text-center">Post a Carpentry Job</h2>
      ...
      {/* Link to CarpentryLaborers component */}
      <div className="mt-4 text-center">
        <Link to="/carpentry/laborers" className="text-blue-500 hover:underline">View Available Laborers</Link>
      </div>
    </div>
  );
};

export default CarpentryJobPost;