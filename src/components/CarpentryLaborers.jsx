...
const laborersData = [
  { name: 'John Doe', rating: 4.5, expertise: 'Carpentry' },
  { name: 'Jane Smith', rating: 4.2, expertise: 'Carpentry' },
  { name: 'Michael Johnson', rating: 4.8, expertise: 'Carpentry' },
  { name: 'Emily Davis', rating: 4.6, expertise: 'Carpentry' }
];

const CarpentryLaborers = () => {
  return (
    <div className="container mx-auto px-4 py-8 min-w-auto">
      <h2 className="text-3xl font-bold mb-4 text-center">Carpentry Laborers</h2>
...
export default CarpentryLaborers;
